...
=head1 Un-Escaping \ of \N, \p, \P, and \X (TIS620 software provides)

TIS620 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (TIS620 software provide)
