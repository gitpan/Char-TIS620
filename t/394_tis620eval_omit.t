...
# Char::TIS620::eval (omit) has Char::TIS620::eval "..."
$_ = <<'END';
...
# Char::TIS620::eval (omit) has Char::TIS620::eval qq{...}
$_ = <<'END';
...
# Char::TIS620::eval (omit) has Char::TIS620::eval q{...}
$_ = <<'END';
...
# Char::TIS620::eval (omit) has Char::TIS620::eval $var
$_ = <<'END';
...
# Char::TIS620::eval (omit) has Char::TIS620::eval (omit)
$_ = <<'END';
