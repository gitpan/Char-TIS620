...
my $color  = Char::TIS620::substr $s, 4, 5;   # black
my $middle = Char::TIS620::substr $s, 4, -11; # black cat climbed the
my $end    = Char::TIS620::substr $s, 14;     # climebed the green tree
my $tail   = Char::TIS620::substr $s, -4;     # tree
my $z      = Char::TIS620::substr $s, -4, 2;  # tr
