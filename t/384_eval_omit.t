...
# eval (omit) has eval "..."
$_ = <<'END';
eval Char::TIS620::escape " if (Char::TIS620::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } "
END
if (eval Char::TIS620::escape) {
...
$_ = <<'END';
eval Char::TIS620::escape qq{ if (Char::TIS620::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
if (eval Char::TIS620::escape) {
...
$_ = <<'END';
eval Char::TIS620::escape q{ if (Char::TIS620::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
if (eval Char::TIS620::escape) {
...
END
my $var2 = q{ if (Char::TIS620::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } };
if (eval Char::TIS620::escape) {
...
# eval (omit) has eval {...}
$_ = <<'END';
eval { if (Char::TIS620::length(q{¦±²²³´´µ¶·¸¹º»¼½¾¿ÀÁÂÃÄÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖ×ØÙÚÛÜ}) == 47) { return 1 } else { return 0 } }
END
if (eval Char::TIS620::escape) {
