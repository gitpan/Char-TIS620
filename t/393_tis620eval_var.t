...
# Char::TIS620::eval $var has Char::TIS620::eval qq{...}
$var = <<'END';
...
# Char::TIS620::eval $var has Char::TIS620::eval q{...}
$var = <<'END';
...
# Char::TIS620::eval $var has Char::TIS620::eval $var
$var = <<'END';
Char::TIS620::eval $var2
END
...
# Char::TIS620::eval $var has Char::TIS620::eval (omit)
$var = <<'END';
Char::TIS620::eval
END
