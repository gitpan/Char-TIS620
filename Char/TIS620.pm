...
END
            ...
            if ($list !~ /\A \s* \z/oxms) {
                ...
                for (@list) {
                    $Char::Etis620::function_ord     = 'Char::TIS620::ord'     if /\A ord \z/oxms;
                    $Char::Etis620::function_ord_    = 'Char::TIS620::ord_'    if /\A ord \z/oxms;
                    $Char::Etis620::function_reverse = 'Char::TIS620::reverse' if /\A reverse \z/oxms;
                    $Char::Etis620::function_getc    = 'Char::TIS620::getc'    if /\A getc \z/oxms;
                }
            }
        }
    }

    $e_script .= Char::TIS620::escape();
...
=head1 Calling 'Char::Etis620::ignorecase()' (Char::TIS620 software provides)

Char::TIS620 software applies calling 'Char::Etis620::ignorecase()' instead of /i modifier.
...
=head1 Un-Escaping \ of \N, \p, \P, and \X (Char::TIS620 software provides)

Char::TIS620 software removes '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
=head1 Escaping Built-in Functions (Char::TIS620 software provide)
...
=head1 Un-Escaping bytes::* Subroutines (Char::TIS620 software provides)

Char::TIS620 software removes 'bytes::' at head of subroutine name.
...
some bugs. Thus, if you happen to find a bug that's in Char::TIS620 software and
