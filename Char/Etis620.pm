...
#
package Char::Etis620;
######################################################################
#
# Char::Etis620 - Run-time routines for Char/TIS620.pm
#
...
BEGIN {
    ...
    sub qualify ($;$) {
        my ($name) = @_;
        if (!ref($name) && (Char::Etis620::index($name, '::') == -1) && (Char::Etis620::index($name, "'") == -1)) {
            my $pkg;
...
sub import {
    ...
    if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
        ...
        for (@ARGV) {
            ...
            # has space
            if (/\A (?:$q_char)*? [ ] /oxms) {
                if (my @glob = Char::Etis620::glob(qq{"$_"})) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
            ...
            # has wildcard metachar
                ...
                if (my @glob = Char::Etis620::glob($_)) {
                    push @argv, @glob;
                }
                else {
                    push @argv, $_;
...
#
sub unimport {}
sub Char::Etis620::split(;$$$);
sub Char::Etis620::tr($$$$;$);
sub Char::Etis620::chop(@);
sub Char::Etis620::index($$;$);
sub Char::Etis620::rindex($$;$);
sub Char::Etis620::lcfirst(@);
sub Char::Etis620::lcfirst_();
sub Char::Etis620::lc(@);
sub Char::Etis620::lc_();
sub Char::Etis620::ucfirst(@);
sub Char::Etis620::ucfirst_();
sub Char::Etis620::uc(@);
sub Char::Etis620::uc_();
sub Char::Etis620::fc(@);
sub Char::Etis620::fc_();
sub Char::Etis620::ignorecase;
sub Char::Etis620::classic_character_class;
sub Char::Etis620::capture;
sub Char::Etis620::chr(;$);
sub Char::Etis620::chr_();
sub Char::Etis620::glob($);
sub Char::Etis620::glob_();

sub Char::TIS620::ord(;$);
sub Char::TIS620::ord_();
sub Char::TIS620::reverse(@);
sub Char::TIS620::getc(;*@);
sub Char::TIS620::length(;$);
sub Char::TIS620::substr($$;$$);
sub Char::TIS620::index($$;$);
sub Char::TIS620::rindex($$;$);
sub Char::TIS620::escape(;$);
...
${Char::Etis620::dot}         = qr{(?:[^\x0A])};
${Char::Etis620::dot_s}       = qr{(?:[\x00-\xFF])};
${Char::Etis620::eD}          = qr{(?:[^0-9])};
...
# ${Char::Etis620::eS}        = qr{(?:[^\x09\x0A    \x0C\x0D\x20])};
# ${Char::Etis620::eS}        = qr{(?:[^\x09\x0A\x0B\x0C\x0D\x20])};
${Char::Etis620::eS}          = qr{(?:[^\s])};

${Char::Etis620::eW}          = qr{(?:[^0-9A-Z_a-z])};
${Char::Etis620::eH}          = qr{(?:[^\x09\x20])};
${Char::Etis620::eV}          = qr{(?:[^\x0A\x0B\x0C\x0D])};
${Char::Etis620::eR}          = qr{(?:\x0D\x0A|[\x0A\x0D])};
${Char::Etis620::eN}          = qr{(?:[^\x0A])};
${Char::Etis620::not_alnum}   = qr{(?:[^\x30-\x39\x41-\x5A\x61-\x7A])};
${Char::Etis620::not_alpha}   = qr{(?:[^\x41-\x5A\x61-\x7A])};
${Char::Etis620::not_ascii}   = qr{(?:[^\x00-\x7F])};
${Char::Etis620::not_blank}   = qr{(?:[^\x09\x20])};
${Char::Etis620::not_cntrl}   = qr{(?:[^\x00-\x1F\x7F])};
${Char::Etis620::not_digit}   = qr{(?:[^\x30-\x39])};
${Char::Etis620::not_graph}   = qr{(?:[^\x21-\x7F])};
${Char::Etis620::not_lower}   = qr{(?:[^\x61-\x7A])};
${Char::Etis620::not_lower_i} = qr{(?:[\x00-\xFF])};
${Char::Etis620::not_print}   = qr{(?:[^\x20-\x7F])};
${Char::Etis620::not_punct}   = qr{(?:[^\x21-\x2F\x3A-\x3F\x40\x5B-\x5F\x60\x7B-\x7E])};
${Char::Etis620::not_space}   = qr{(?:[^\s\x0B])};
${Char::Etis620::not_upper}   = qr{(?:[^\x41-\x5A])};
${Char::Etis620::not_upper_i} = qr{(?:[\x00-\xFF])};
${Char::Etis620::not_word}    = qr{(?:[^\x30-\x39\x41-\x5A\x5F\x61-\x7A])};
${Char::Etis620::not_xdigit}  = qr{(?:[^\x30-\x39\x41-\x46\x61-\x66])};
${Char::Etis620::eb}          = qr{(?:\A(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[0-9A-Z_a-z])|(?<=[0-9A-Z_a-z])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]|\z))};
${Char::Etis620::eB}          = qr{(?:(?<=[0-9A-Z_a-z])(?=[0-9A-Z_a-z])|(?<=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF])(?=[\x00-\x2F\x40\x5B-\x5E\x60\x7B-\xFF]))};

# avoid: Name "Char::Etis620::foo" used only once: possible typo at here.
${Char::Etis620::dot}         = ${Char::Etis620::dot};
${Char::Etis620::dot_s}       = ${Char::Etis620::dot_s};
${Char::Etis620::eD}          = ${Char::Etis620::eD};
${Char::Etis620::eS}          = ${Char::Etis620::eS};
${Char::Etis620::eW}          = ${Char::Etis620::eW};
${Char::Etis620::eH}          = ${Char::Etis620::eH};
${Char::Etis620::eV}          = ${Char::Etis620::eV};
${Char::Etis620::eR}          = ${Char::Etis620::eR};
${Char::Etis620::eN}          = ${Char::Etis620::eN};
${Char::Etis620::not_alnum}   = ${Char::Etis620::not_alnum};
${Char::Etis620::not_alpha}   = ${Char::Etis620::not_alpha};
${Char::Etis620::not_ascii}   = ${Char::Etis620::not_ascii};
${Char::Etis620::not_blank}   = ${Char::Etis620::not_blank};
${Char::Etis620::not_cntrl}   = ${Char::Etis620::not_cntrl};
${Char::Etis620::not_digit}   = ${Char::Etis620::not_digit};
${Char::Etis620::not_graph}   = ${Char::Etis620::not_graph};
${Char::Etis620::not_lower}   = ${Char::Etis620::not_lower};
${Char::Etis620::not_lower_i} = ${Char::Etis620::not_lower_i};
${Char::Etis620::not_print}   = ${Char::Etis620::not_print};
${Char::Etis620::not_punct}   = ${Char::Etis620::not_punct};
${Char::Etis620::not_space}   = ${Char::Etis620::not_space};
${Char::Etis620::not_upper}   = ${Char::Etis620::not_upper};
${Char::Etis620::not_upper_i} = ${Char::Etis620::not_upper_i};
${Char::Etis620::not_word}    = ${Char::Etis620::not_word};
${Char::Etis620::not_xdigit}  = ${Char::Etis620::not_xdigit};
${Char::Etis620::eb}          = ${Char::Etis620::eb};
${Char::Etis620::eB}          = ${Char::Etis620::eB};
...
sub Char::Etis620::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Etis620::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Etis620::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Etis620::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Etis620::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Etis620::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Etis620::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Etis620::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Etis620::uc($char[$i]);
                my $fc = Char::Etis620::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # POSIX-style character classes
            ...
            $char[$i] = {
                ...
                '[:^lower:]'  => '${Char::Etis620::not_lower_i}',
                '[:^upper:]'  => '${Char::Etis620::not_upper_i}',
            ...
            $char[$i] = {
                ...
                '[:^alnum:]'  => '${Char::Etis620::not_alnum}',
                '[:^alpha:]'  => '${Char::Etis620::not_alpha}',
                '[:^ascii:]'  => '${Char::Etis620::not_ascii}',
                '[:^blank:]'  => '${Char::Etis620::not_blank}',
                '[:^cntrl:]'  => '${Char::Etis620::not_cntrl}',
                '[:^digit:]'  => '${Char::Etis620::not_digit}',
                '[:^graph:]'  => '${Char::Etis620::not_graph}',
                '[:^lower:]'  => '${Char::Etis620::not_lower}',
                '[:^print:]'  => '${Char::Etis620::not_print}',
                '[:^punct:]'  => '${Char::Etis620::not_punct}',
                '[:^space:]'  => '${Char::Etis620::not_space}',
                '[:^upper:]'  => '${Char::Etis620::not_upper}',
                '[:^word:]'   => '${Char::Etis620::not_word}',
                '[:^xdigit:]' => '${Char::Etis620::not_xdigit}',
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Etis620::uc($char);
                        my $fc = Char::Etis620::fc($char);
                        if ($uc eq $fc) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Etis620::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Etis620::fc($_[0]) =~ /\A $pattern \z/xms };
...
INNER:
        for my $leaf (@leaf) {
            ...
            if (Char::Etis620::index($leaf,'.') == -1 and   # if name does not have a dot in it *and*
                CORE::length($leaf) <= 8 and        # name is shorter than or equal to 8 chars *and*
                Char::Etis620::index($pattern,'\\.') != -1  # pattern has a dot.
            ) {
                if (&$matchsub("$leaf.")) {
                    push @matched, "$head$leaf";
                    next INNER;
...
sub Char::TIS620::getc(;*@) {
    ...
    croak 'Too many arguments for Char::TIS620::getc' if @_ and not wantarray;
    ...
    for my $length ($length[0] .. $length[-1]) {
        ...
        if (exists $range_tr{CORE::length($getc)}) {
            if ($getc =~ /\A ${Char::Etis620::dot_s} \z/oxms) {
...
sub Char::TIS620::index($$;$) {
    ...
    my $index;
    if (@_ == 3) {
        $index = Char::Etis620::index($_[0], $_[1], CORE::length(Char::TIS620::substr($_[0], 0, $_[2])));
    }
    else {
        $index = Char::Etis620::index($_[0], $_[1]);
    }
    ...
    if ($index == -1) {
        ...
        return Char::TIS620::length(CORE::substr $_[0], 0, $index);
    }
}
...
sub Char::TIS620::rindex($$;$) {
    ...
    my $rindex;
    if (@_ == 3) {
        $rindex = Char::Etis620::rindex($_[0], $_[1], CORE::length(Char::TIS620::substr($_[0], 0, $_[2])));
    }
    else {
        $rindex = Char::Etis620::rindex($_[0], $_[1]);
    }
    ...
    if ($rindex == -1) {
        ...
        return Char::TIS620::length(CORE::substr $_[0], 0, $rindex);
    }
}
...
my $qq_substr  = qr{(?: Char::TIS620::substr | CORE::substr | substr ) \( $qq_paren \)
                 }xms;
...
sub Char::TIS620::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::TIS620::escape_token();
    }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Etis620::PREMATCH()
    elsif (/\G ( \$` | \$\{`\} | \$ \s* PREMATCH  \b | \$ \s* \{ \s* PREMATCH  \s* \} | \$ \s* \{\^PREMATCH\}  ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Etis620::PREMATCH()};
    }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Etis620::MATCH()
    elsif (/\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Etis620::MATCH()};
    }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Etis620::POSTMATCH()
    elsif (/\G (                 \$ \s* POSTMATCH \b | \$ \s* \{ \s* POSTMATCH \s* \} | \$ \s* \{\^POSTMATCH\} ) /oxmsgc) {
        $slash = 'div';
        return q{Char::Etis620::POSTMATCH()};
    }
...
# while (<WILDCARD>) --- glob
    ...
    # avoid "Error: Runtime exception" of perl version 5.005_03
        ...
        return 'while ($_ = Char::Etis620::glob("' . $1 . '"))';
    }

# while (glob)
    elsif (/\G \b while \s* \( \s* glob \s* \) /oxgc) {
        return 'while ($_ = Char::Etis620::glob_)';
    }

# while (glob(WILDCARD))
    elsif (/\G \b while \s* \( \s* glob \b /oxgc) {
        return 'while ($_ = Char::Etis620::glob';
    }
...
# subroutines of package Char::Etis620
    elsif (/\G \b (CORE:: | ->[ ]* (?: atan2 | [a-z]{2,})) \b  /oxgc) { $slash = 'm//'; return $1;                  }
    elsif (/\G \b Char::TIS620::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::TIS620::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::TIS620::escape'; }
    elsif (/\G \b bytes::substr \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'substr';            }
    elsif (/\G \b chop \b          (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Etis620::chop';       }
    elsif (/\G \b bytes::index \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'index';             }
    elsif (/\G \b Char::TIS620::index \b   (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::TIS620::index';       }
    elsif (/\G \b index \b         (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Etis620::index';      }
    elsif (/\G \b bytes::rindex \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'rindex';            }
    elsif (/\G \b Char::TIS620::rindex \b  (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::TIS620::rindex';      }
    elsif (/\G \b rindex \b        (?! \s* => )                /oxgc) { $slash = 'm//'; return 'Char::Etis620::rindex';     }
    elsif (/\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Etis620::lc';         }
    elsif (/\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Etis620::lcfirst';    }
    elsif (/\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Etis620::uc';         }
    elsif (/\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Etis620::ucfirst';    }
    elsif (/\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Etis620::fc';         }
    ...
    elsif (/\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Etis620::chr';               }
    elsif (/\G \b bytes::ord    (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'div'; return $function_ord;              }
    elsif (/\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $slash = 'm//'; return 'Char::Etis620::glob';              }
    elsif (/\G \b lc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Etis620::lc_';               }
    elsif (/\G \b lcfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Etis620::lcfirst_';          }
    elsif (/\G \b uc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Etis620::uc_';               }
    elsif (/\G \b ucfirst \b       (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Etis620::ucfirst_';          }
    elsif (/\G \b fc \b            (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Etis620::fc_';               }
    ...
    elsif (/\G \b chr \b           (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Etis620::chr_';              }
    elsif (/\G \b bytes::ord \b    (?! \s* => )                      /oxgc) { $slash = 'div'; return 'ord';                      }
    elsif (/\G \b ord \b           (?! \s* => )                      /oxgc) { $slash = 'div'; return $function_ord_;             }
    elsif (/\G \b glob \b          (?! \s* => )                      /oxgc) { $slash = 'm//'; return 'Char::Etis620::glob_';             }
...
# end of split
        if    (/\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Etis620::split' . $e;                 }

# split scalar value
        elsif (/\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { return 'Char::Etis620::split' . $e . e_string($1);  }

# split literal space
        elsif (/\G \b qq       (\#) [ ] (\#) /oxgc) { return 'Char::Etis620::split' . $e . qq  {qq$1 $2}; }
        elsif (/\G \b qq (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; }
        elsif (/\G \b q        (\#) [ ] (\#) /oxgc) { return 'Char::Etis620::split' . $e . qq   {q$1 $2}; }
        elsif (/\G \b q  (\s*) (\() [ ] (\)) /oxgc) { return 'Char::Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { return 'Char::Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { return 'Char::Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { return 'Char::Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { return 'Char::Etis620::split' . $e . qq {$1q$2 $3}; }
        elsif (/\G                ' [ ] '    /oxgc) { return 'Char::Etis620::split' . $e . qq     {' '};  }
        elsif (/\G                " [ ] "    /oxgc) { return 'Char::Etis620::split' . $e . qq     {" "};  }
...
# $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> @{[Char::Etis620::PREMATCH()]}
            ...
            $e_string .= q{Char::Etis620::PREMATCH()};
            $slash = 'div';
        }

# $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> @{[Char::Etis620::MATCH()]}
        elsif ($string =~ /\G ( \$& | \$\{&\} | \$ \s* MATCH     \b | \$ \s* \{ \s* MATCH     \s* \} | \$ \s* \{\^MATCH\}     ) /oxmsgc) {
            $e_string .= q{Char::Etis620::MATCH()};
            $slash = 'div';
        }
...
# $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> @{[Char::Etis620::POSTMATCH()]}
            ...
            $e_string .= q{Char::Etis620::POSTMATCH()};
            $slash = 'div';
        }
...
# subroutines of package Char::Etis620
        ...
        elsif ($string =~ /\G \b Char::TIS620::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::TIS620::eval \b                                /oxgc) { $e_string .= 'eval Char::TIS620::escape'; $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::substr \b                             /oxgc) { $e_string .= 'substr';            $slash = 'm//'; }
        elsif ($string =~ /\G \b chop \b                                      /oxgc) { $e_string .= 'Char::Etis620::chop';       $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::index \b                              /oxgc) { $e_string .= 'index';             $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::TIS620::index \b                               /oxgc) { $e_string .= 'Char::TIS620::index';       $slash = 'm//'; }
        elsif ($string =~ /\G \b index \b                                     /oxgc) { $e_string .= 'Char::Etis620::index';      $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::rindex \b                             /oxgc) { $e_string .= 'rindex';            $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::TIS620::rindex \b                              /oxgc) { $e_string .= 'Char::TIS620::rindex';      $slash = 'm//'; }
        elsif ($string =~ /\G \b rindex \b                                    /oxgc) { $e_string .= 'Char::Etis620::rindex';     $slash = 'm//'; }
        elsif ($string =~ /\G \b lc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Etis620::lc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Etis620::lcfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b uc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Etis620::uc';         $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Etis620::ucfirst';    $slash = 'm//'; }
        elsif ($string =~ /\G \b fc      (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Etis620::fc';         $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr           (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Etis620::chr';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b glob          (?= \s+[A-Za-z_]|\s*['"`\$\@\&\*\(]) /oxgc) { $e_string .= 'Char::Etis620::glob';              $slash = 'm//'; }
        elsif ($string =~ /\G \b lc \b                                              /oxgc) { $e_string .= 'Char::Etis620::lc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b lcfirst \b                                         /oxgc) { $e_string .= 'Char::Etis620::lcfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b uc \b                                              /oxgc) { $e_string .= 'Char::Etis620::uc_';               $slash = 'm//'; }
        elsif ($string =~ /\G \b ucfirst \b                                         /oxgc) { $e_string .= 'Char::Etis620::ucfirst_';          $slash = 'm//'; }
        elsif ($string =~ /\G \b fc \b                                              /oxgc) { $e_string .= 'Char::Etis620::fc_';               $slash = 'm//'; }
        ...
        elsif ($string =~ /\G \b chr \b                                             /oxgc) { $e_string .= 'Char::Etis620::chr_';              $slash = 'm//'; }
        elsif ($string =~ /\G \b bytes::ord \b                                      /oxgc) { $e_string .= 'ord';                      $slash = 'div'; }
        elsif ($string =~ /\G \b ord \b                                             /oxgc) { $e_string .= $function_ord_;             $slash = 'div'; }
        elsif ($string =~ /\G \b glob \b                                            /oxgc) { $e_string .= 'Char::Etis620::glob_';             $slash = 'm//'; }
...
# end of split
            if    ($string =~ /\G (?= [,;\)\}\]] )          /oxgc) { return 'Char::Etis620::split' . $e;                                           }

# split scalar value
            elsif ($string =~ /\G ( [\$\@\&\*] $qq_scalar ) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . e_string($1);  next E_STRING_LOOP; }

# split literal space
            elsif ($string =~ /\G \b qq       (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq  {qq$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b qq (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq{$1qq$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q        (\#) [ ] (\#) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq   {q$1 $2}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\() [ ] (\)) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\{) [ ] (\}) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\[) [ ] (\]) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\<) [ ] (\>) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G \b q  (\s*) (\S) [ ] (\2) /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq {$1q$2 $3}; next E_STRING_LOOP; }
            elsif ($string =~ /\G                ' [ ] '    /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq     {' '};  next E_STRING_LOOP; }
            elsif ($string =~ /\G                " [ ] "    /oxgc) { $e_string .= 'Char::Etis620::split' . $e . qq     {" "};  next E_STRING_LOOP; }
...
sub character_class {
    ...
    if ($char eq '.') {
        if ($modifier =~ /s/) {
            return '${Char::Etis620::dot_s}';
        }
        else {
            return '${Char::Etis620::dot}';
        }
    }
    else {
        return Char::Etis620::classic_character_class($char);
    }
}
...
sub e_tr {
    ...
    if ($modifier =~ tr/bB//d) {
        ...
        if ($variable eq '') {
            $e_tr = qq{Char::Etis620::tr(\$_,' =~ ',$charclass,$e$charclass2,'$modifier')};
        }
        else {
            $e_tr = qq{Char::Etis620::tr($variable,'$bind_operator',$charclass,$e$charclass2,'$modifier')};
        }
    }
...
sub e_qq {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # octal escape sequence
            ...
            $char[$i] = Char::Etis620::octchr($1);
        }

        # hexadecimal escape sequence
        elsif ($char[$i] =~ /\A \\x \{ ([0-9A-Fa-f]+) \} \z/oxms) {
            $char[$i] = Char::Etis620::hexchr($1);
        }
        ...
        # \u \l \U \L \F \Q \E
            ...
            $char[$i] = '@{[Char::Etis620::ucfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\l') {
            $char[$i] = '@{[Char::Etis620::lcfirst qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\U') {
            $char[$i] = '@{[Char::Etis620::uc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\L') {
            $char[$i] = '@{[Char::Etis620::lc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\F') {
            $char[$i] = '@{[Char::Etis620::fc qq<';
            $left_e++;
        }
        elsif ($char[$i] eq '\Q') {
...
sub e_qr {
    ...
    for (my $i=0; $i <= $#char; $i++) {
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Etis620::charlist_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Etis620::charlist_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # open character class [^...]
            ...
            while (1) {
                ...
                if ($char[$i] eq ']') {
                    ...
                    # [^...]
                    if (grep(/\A [\$\@]/oxms,@char[$left+1..$right-1]) >= 1) {
                        splice @char, $left, $right-$left+1, sprintf(q{@{[Char::Etis620::charlist_not_qr(%s,'%s')]}}, join(',', map {qq_stuff($delimiter,$end_delimiter,$_)} @char[$left+1..$right-1]), $modifier);
                    }
                    else {
                        splice @char, $left, $right-$left+1, Char::Etis620::charlist_not_qr(@char[$left+1..$right-1], $modifier);
                    }
        ...
        # /i modifier
        elsif ($ignorecase and ($char[$i] =~ /\A [\x00-\xFF] \z/oxms) and (Char::Etis620::uc($char[$i]) ne Char::Etis620::fc($char[$i]))) {
            if (CORE::length(Char::Etis620::fc($char[$i])) == 1) {
                $char[$i] = '['   . Char::Etis620::uc($char[$i])       . Char::Etis620::fc($char[$i]) . ']';
            }
            else {
                $char[$i] = '(?:' . Char::Etis620::uc($char[$i]) . '|' . Char::Etis620::fc($char[$i]) . ')';
            }
        ...
        # $0 --> $0
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Etis620::ignorecase(' . $char[$i] . ')]}';
            }
        }
        elsif ($char[$i] =~ /\A \$ \{ \s* 0 \s* \} \z/oxms) {
            if ($ignorecase) {
        ...
        # $`, ${`}, $PREMATCH, ${PREMATCH}, ${^PREMATCH} --> Char::Etis620::PREMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Etis620::ignorecase(Char::Etis620::PREMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Etis620::PREMATCH()]}';
            }
        ...
        # $&, ${&}, $MATCH, ${MATCH}, ${^MATCH} --> Char::Etis620::MATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Etis620::ignorecase(Char::Etis620::MATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Etis620::MATCH()]}';
            }
        ...
        # $POSTMATCH, ${POSTMATCH}, ${^POSTMATCH} --> Char::Etis620::POSTMATCH()
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Etis620::ignorecase(Char::Etis620::POSTMATCH())]}';
            }
            else {
                $char[$i] = '@{[Char::Etis620::POSTMATCH()]}';
            }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::TIS620::re_t=%s; while($Char::TIS620::re_t =~ %s){%s local $^W=0; local $Char::TIS620::re_r=%s; %s$Char::TIS620::re_t="$`$Char::TIS620::re_r$'"; pos($Char::TIS620::re_t)=length "$`$Char::TIS620::re_r"; } return $Char::TIS620::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::TIS620::re_r=CORE::eval $Char::TIS620::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::TIS620::re_r=%s; %s"%s$Char::TIS620::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::TIS620::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::TIS620::re_r=%s; %s%s="$`$Char::TIS620::re_r$'"; pos(%s)=length "$`$Char::TIS620::re_r"; $Char::TIS620::re_n++} return %s$Char::TIS620::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::TIS620::re_r=%s; %s%s="%s$Char::TIS620::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::TIS620::re_r=%s; %s%s="%s$Char::TIS620::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::TIS620::re_r=CORE::eval $Char::TIS620::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
sub e_split {
    ...
    for (my $i=0; $i <= $#char; $i++) {
        ...
        # ${ foo }
            ...
            if ($ignorecase) {
                $char[$i] = '@{[Char::Etis620::ignorecase(' . $1 . ')]}';
            }
        }
    ...
    $modifier =~ tr/i//d;
    if ($left_e > $right_e) {
        return join '', 'Char::Etis620::split', $ope, $delimiter, @char, '>]}' x ($left_e - $right_e), $end_delimiter, $modifier;
    }
    return     join '', 'Char::Etis620::split', $ope, $delimiter, @char,                               $end_delimiter, $modifier;
}
...
=head1 SYNOPSIS
  ...
  use Char::Etis620;
    ...
    Char::Etis620::lc(...);
    Char::Etis620::lc_;
    Char::Etis620::lcfirst(...);
    Char::Etis620::lcfirst_;
    Char::Etis620::uc(...);
    Char::Etis620::uc_;
    Char::Etis620::ucfirst(...);
    Char::Etis620::ucfirst_;
    Char::Etis620::fc(...);
    Char::Etis620::fc_;
    Char::Etis620::ignorecase(...);
    Char::Etis620::capture(...);
    Char::Etis620::chr(...);
    Char::Etis620::chr_;
    Char::Etis620::glob(...);
    Char::Etis620::glob_;

  # "no Char::Etis620;" not supported

=head1 ABSTRACT

This module has run-time routines for use Char::TIS620 software automatically, you
do not have to use.
...
some bugs. Thus, if you happen to find a bug that's in Char::TIS620 software and not
...
This Char::Etis620 module first appeared in ActivePerl Build 522 Built under
...
=item Split string
  ...
  @split = Char::Etis620::split(/pattern/,$string,$limit);
  @split = Char::Etis620::split(/pattern/,$string);
  @split = Char::Etis620::split(/pattern/);
  @split = Char::Etis620::split('',$string,$limit);
  @split = Char::Etis620::split('',$string);
  @split = Char::Etis620::split('');
  @split = Char::Etis620::split();
  @split = Char::Etis620::split;
  ...
  at all, Char::Etis620::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Etis620::split(//,  $word);
  @fields = Char::Etis620::split(/:/, $line);
  @words  = Char::Etis620::split(" ", $paragraph);
  @lines  = Char::Etis620::split(/^/, $buffer);
  ...
  print join(":" => Char::Etis620::split(/ */, "hi there"));
  ...
  Char::Etis620::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Etis620::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Etis620::split with no arguments does. Thus,
  Char::Etis620::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Etis620::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Etis620::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Etis620::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Etis620::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Etis620::split is join, except that join can only join with the
...
=item Transliteration
  ...
  $tr = Char::Etis620::tr($variable,$bind_operator,$searchlist,$replacementlist,$modifier);
  $tr = Char::Etis620::tr($variable,$bind_operator,$searchlist,$replacementlist);
  ...
  print Char::Etis620::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'

=item Chop string

  $chop = Char::Etis620::chop(@list);
  $chop = Char::Etis620::chop();
  $chop = Char::Etis620::chop;

  This subroutine chops off the last character of a string variable and returns the
  character chopped. The Char::Etis620::chop subroutine is used primary to remove the newline
  ...
  since Char::Etis620::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Etis620::chop a literal, only a variable. If you Char::Etis620::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Etis620::chop(@lines);

  You can Char::Etis620::chop anything that is an lvalue, including an assignment:

  Char::Etis620::chop($cwd = `pwd`);
  Char::Etis620::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Etis620::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Etis620::chop returns the character
  ...
  In the most general case, Char::Etis620::chop can be expressed using substr:

  $last_code = Char::Etis620::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Etis620::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Etis620::chop;
...
=item Index string
  ...
  $byte_pos = Char::Etis620::index($string,$substr,$byte_offset);
  $byte_pos = Char::Etis620::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Etis620::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Etis620::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Etis620::rindex($string,$substr);

  This subroutine works just like Char::Etis620::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Etis620::index).
  ...
  while (($byte_pos = Char::TIS620::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  You can use the Char::Etis620::fc subroutine for case-insensitive comparisons via Char::TIS620
  software.

=item Lower case first character of string

  $lcfirst = Char::Etis620::lcfirst($string);
  $lcfirst = Char::Etis620::lcfirst_;
...
=item Upper case string
  ...
  in interpolated strings. For titlecase, use Char::Etis620::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Etis620::ucfirst($string);
  $ucfirst = Char::Etis620::ucfirst_;
  ...
  $titlecase = Char::Etis620::ucfirst(substr($word,0,1)) . Char::Etis620::lc(substr($word,1));
  ...
  $do_not_use = Char::Etis620::ucfirst(Char::Etis620::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Etis620::fc($string);
  $fc = Char::Etis620::fc_;

  New to Char::TIS620 software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Etis620::fc($a) eq Char::Etis620::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::TIS620 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Etis620::ignorecase(@string);

  This subroutine is internal use to m/ /i, s/ / /i, split / /i, and qr/ /i.

=item Make capture number

  $capturenumber = Char::Etis620::capture($string);

  This subroutine is internal use to m/ /, s/ / /, split / /, and qr/ /.

=item Make character

  $chr = Char::Etis620::chr($code);
  $chr = Char::Etis620::chr_;

  This subroutine returns a programmer-visible character, character represented by
  that $code in the character set. For example, Char::Etis620::chr(65) is "A" in either
  ASCII or TIS-620, not Unicode. For the reverse of Char::Etis620::chr, use Char::TIS620::ord.

=item Filename expansion (globbing)

  @glob = Char::Etis620::glob($string);
  @glob = Char::Etis620::glob_;
  ...
  The Char::Etis620::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Etis620::glob('"*e f*"');
  @spacies = Char::Etis620::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Etis620::glob("'*${var}e f*'");
  @spacies = Char::Etis620::glob(qq("*${var}e f*"));
